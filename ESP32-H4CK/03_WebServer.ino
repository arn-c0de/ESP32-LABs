...
void setupRoutes() {
  ...
  server.on("/login", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    if (fileExists("/login.html")) {
      ...
      html += "<div class='form-group'><label>Username</label><input type='text' name='username' required placeholder='Enter your username'></div>";
      html += "<div class='form-group'><label>Password</label><input type='password' name='password' required placeholder='Enter your password'></div>";
