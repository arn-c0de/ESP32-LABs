...
- **ESP32-H4CK-SCADA — Industrial SCADA Lab**: A red, blue , white team-oriented SCADA training environment simulating multi-line production with realistic sensor physics and six independent exploit paths. See the lab documentation and exercises in [ESP32-H4CK-SCADA/README.md](ESP32-H4CK-SCADA/README.md) and the quick start guide: [ESP32-H4CK-SCADA/QUICKSTART.md](ESP32-H4CK-SCADA/QUICKSTART.md).
